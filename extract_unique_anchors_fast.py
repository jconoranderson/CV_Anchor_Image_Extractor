...
TOP_N_PER_PERSON = 25  # Number of anchor images to output per unique person
...
# Place the models in the same directory as the script so they aren't repeatedly downloaded
